            ...
            <div className="navbar">
              ...
              <navbar>
                <ul>
                  ...
                  <li><a href="venda.html">COMPRAR</a></li>
                  <li><a href="login.html"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="25px" viewBox="0 0 510 510" style={{enableBackground: 'new 0 0 510 510'}} xmlSpace="preserve">
                        <g>
                          <g id="account-circle">
